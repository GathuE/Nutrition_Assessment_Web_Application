                ...
                <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <div class="card-body">
                      <div class="container-fluid">
                          <form id="breakfastform" name="mealone" class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:blue;" action="insert_breakfast.php" method="post">
                                  <div class="row">
                                      <!-- Breakfast -->
                                      <div class="col">
                                          <!-- Food Choice -->
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit"   class="btn btn-info" id="breko" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Breakfast">
                                        </div>
