                ...
                <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <div class="card-body">
                      <div class="container-fluid">
                         ...
                         <a href="#"  class="btn btn-info" style="color:white;font-size: 12px;font-weight:300;">Guide Book</a><br><br>  -->
                          <button type="button" class="btn" style="font-size:12px;background-color:purple;color:white;" onclick="start();">Begin Assessment</button>
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="card" id="innercard" style="position:relative;display:none;top:10px;border-radius:5px; cursor:pointer;">
                                <div class="card-header" style="font-size: 22px;font-weight:900;text-align:center; font-family:'Patrick Hand', cursive;color:purple;">
                                 More About the Client <br>
                                <small style="color:blue; font-size:14px;"><b>Providing the correct information improves the accuracy of Findings and how effective the application serves you.</b></small>   
                            </div>
                            <div class="card-body">
                                <div class="container-fluid">
                                    ...
                                    <form class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:blue;" id="patientform" name="dataform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                            ...
                                            <input type="button" class="btn btn-primary" style="font-size:12px;" id="btn" value="Calculate Nutrients Requirement" onclick="divswap();EER();"><br>
                            ...
                            <div class="card-footer">
                                    <p style="font-size:16px;font-weight:500;color:purple;">I already know my Nutrient Requirements.<br>
            ...
            <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12" id="food" style="position:relative;display:none;top:20px;border-radius:5px; cursor:pointer;">
                    <div class="card" id="display">
                            ...
                            <form name="eercomposition" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                <table class="table table-striped table-sm text-center">
                                    <thead>
                                            <tr>
                                                <td colspan="5">
                                                <h6 style="font-size:17px;font-family: 'Patrick Hand', cursive;font-weight:600;color:purple;">Based on the Data You Provided, <br> YOUR DIETARY REFERENCE INTAKES ARE :</h6>
                                                </td>
                                            </tr>
                        ...
                        <div class="card-footer">
                                <input type="button" id="savebtn" class="btn btn-success my-2 btn-block"style="font-size: 14px;width: 150px;height: 35px;margin-left:auto;margin-right:auto;" onclick="this.disabled = true;meals();" value="Save and Proceed">
                        </div>       
                  </div>
                </div>   
              </div>
                    ...
                    <div class="row justify-content center">
                            <div class="col-12 col-sm-12 col-md-12" id="prompt" style="position:relative;display:none;top:20px;border-radius:5px; cursor:pointer;">
                                    <div class="card" id="display">
                                        <div class="card-body">
                                            <div class="container-fluid">
                                                <p> Guide User on how to Input Meals especially on the choice of serving items.</p>
                                                <p>Pictorials to be Used</p>
                                                        
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <a  class="btn btn-info" style="font-size:12px;" href="breakfast_meal.php">Proceed</a>
                                        </div>
