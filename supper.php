                ...
                <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <div class="card-body">
                      <div class="container-fluid">
                          <form class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:blue;" action="insert_supper.php" method="post">
                                  <div class="row">
                                      <!-- Breakfast -->
                                      <div class="col">
                                          <!-- Food Choice -->
                                          <label> Did You Have Supper ? :</label><br>
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit" id="breko"  class="btn btn-info" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Supper">
                                        </div>
                                        
                                </div> 
                                        <div class="card-footer">
                                              <a class="btn btn-info" style="font-size:12px;width:150px;float:left;" href="midafternoon.php">Previous Meal</a>
                                              <a class="btn btn-info" style="font-size:12px;width:150px;float:right;" href="late_supper.php">Next Meal</a>
                                        </div>
                              </div>
                          </form>
