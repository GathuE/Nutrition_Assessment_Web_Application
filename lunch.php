                ...
                <div class="col-12 col-sm-12 col-md-12">
                    ...
                    <div class="card-body">
                      <div class="container-fluid">
                          <form class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:blue;" action="insert_lunch.php" method="post">
                                  <div class="row">
                                      <!-- Breakfast -->
                                      <div class="col">
                                          <!-- Food Choice -->
                                          <label> Did You Have Lunch ? </label><br>
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit" id="breko"  class="btn btn-info" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Lunch">
                                        </div>
