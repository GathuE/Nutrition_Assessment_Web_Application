          ...
          <div class="row justify-content center">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="card" id="breakfast" class="divs" style="position:relative;top:20px;border-radius:5px; cursor:pointer;">
                        <div class="card-header" style="font-size: 20px;font-weight:900;text-align:center; font-family:'Patrick Hand', cursive;color:purple;">Mid Afternoon Meal : <br>    
                    </div>
                    <div class="card-body">
                      <div class="container-fluid">
                          <form class="text-center p-3" style="font-family: monospace;font-size:12px;font-weight:500;color:blue;" action="insert_midafternoon.php" method="post">
                                  <div class="row">
                                      <!-- Breakfast -->
                                      <div class="col">
                                          <!-- Food Choice -->
                                          <label> Did You Have a Mid Afternoon Meal ? </label><br>
                                ...
                                <div id="ifYes" style="display:none">
                                        ...
                                        <div class="form-group">
                                              <input type="submit" id="breko"  class="btn btn-info" style="font-size:12px;width:150px;margin-right:auto;" value="Add to Mid Afternoon">
                                        </div>
